...
Validation.add('validate-turkish-tel','Please enter a valid phone number. For example (123) 456-7890 or 123-456-7890.',function(v){
    return Validation.get('IsEmpty').test(v) || /^[+]?(\d{1,3})?\s*(\()?\d{3}(\))?\s*\d{7}$/.test(v);
});    
